                                ...
                                <label className="flex flex-col min-w-40 h-12 w-full">
                                    <div className="flex w-full flex-1 items-stretch rounded-xl h-full">
                                        ...
                                        <div className="flex items-center justify-center p-1">
                                            <button className="bg-green-500 text-white rounded-full hover:bg-green-800 active:bg-green-700 flex items-center justify-center w-8 h-8" onClick={() => { setShowGroupChatCreateModal(true); console.log("Open GroupChat Modal Button"); }}>
